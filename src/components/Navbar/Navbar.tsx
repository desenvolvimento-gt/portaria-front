...
export function Navbar() {
  ...
  return isTabletOrMobile ? (
    <nav className="flex top-0 left-1/5 w-full h-14 bg-white rounded-lg">
      <span className="pl-5 w-1/6 self-center text-center text-xl font-semibold whitespace-nowrap ">
        IEAD-Portaria
      </span>
      ...
      {isVisible && (
        <div className="z-50 w-full h-auto absolute top-14 left-0 bg-white rounded-lg">
    ...
    <nav className="flex top-0 left-1/5 w-full h-14 bg-white rounded-lg">
      <span className="w-1/6 ml-14 self-center text-center text-xl font-semibold whitespace-nowrap ">
        IEAD-Portaria
      </span>
      <div className="flex self-center justify-end pr-10 w-full text-center">
        <Link to="/">
